...
\begin{frame}{Issues with McEliece}{\ldots{}and Fixing Them}
  ...
  \item Unfortunately, McEliece requires a key size of roughly
    ...
    embedded devices.
  \item \Citeauthor{GPT91} proposed the GPT cryptosystem which uses
...
\begin{frame}{Generating Gabidulin Codes}
  \Citeauthor{Gab85} constructed a family of Maximum Rank Distance
...
\begin{frame}{Gabidulin vs.\ Random}
  ...
  obtain something quite different.  \Citeauthor{Ove05} formulated a
...
\begin{frame}{Reparation by \citeauthor{Loi17}}
  ...
  \end{itemize}
  \Citeauthor{Loi17} tackled these issues by
  \begin{enumerate}
...
\begin{frame}{Support-Trapping Algorithm by \citeauthor{GRS13}}
  ...
  \item \Citeauthor{GRS13} showed how to retrieve \(\vec{e}\) in time
